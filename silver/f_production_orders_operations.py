...
# MAGIC %sql
# MAGIC CREATE SCHEMA IF NOT EXISTS bronze_industrial_analytics;
# MAGIC CREATE SCHEMA IF NOT EXISTS silver_industrial_analytics;
# MAGIC CREATE SCHEMA IF NOT EXISTS gold_industrial_analytics;
